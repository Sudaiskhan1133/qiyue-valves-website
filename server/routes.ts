...
export async function registerRoutes(
  ...
  app.get("/sitemap.xml", async (_req, res) => {
    try {
      ...
      const baseUrl = "https://qiyuevalves.com";

      let xml = `<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url><loc>${baseUrl}/</loc><changefreq>weekly</changefreq><priority>1.0</priority></url>
  <url><loc>${baseUrl}/products</loc><changefreq>weekly</changefreq><priority>0.9</priority></url>
  ...
  <url><loc>${baseUrl}/contact</loc><changefreq>monthly</changefreq><priority>0.7</priority></url>`;
      ...
      for (const cat of categories) {
        xml += `\n  <url><loc>${baseUrl}/products?category=${cat.slug}</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>`;
      }

      for (const product of products) {
        xml += `\n  <url><loc>${baseUrl}/products/${product.slug}</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>`;
      }
